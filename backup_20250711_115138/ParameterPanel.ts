...
export class ParameterPanel {
    ...
    private initializeSliders(): void {
        ...
        const particlesPerSpeciesSlider = document.getElementById('particlesPerSpeciesSlider') as HTMLInputElement;
        ...
        const minDistanceSlider = document.getElementById('minDistanceSlider') as HTMLInputElement;
        ...
        const maxDistanceSlider = document.getElementById('maxDistanceSlider') as HTMLInputElement;
        ...
        const particleSizeSlider = document.getElementById('particleSizeSlider') as HTMLInputElement;
        ...
        const glowIntensitySlider = document.getElementById('glowIntensitySlider') as HTMLInputElement;
    ...
    private initializePresetSelector(): void {
        ...
        presetSelect.innerHTML = `
            ...
            <optgroup label="Ventrella Physics">
                ${allPresets.filter(p => p.type === 'ventrella').map(preset => 
                    `<option value="${preset.type}:${preset.value}">${preset.name}</option>`
                ).join('')}
            </optgroup>
            <optgroup label="Nature Behaviors">
                ${allPresets.filter(p => p.type === 'nature').map(preset => 
                    `<option value="${preset.type}:${preset.value}">${preset.name}</option>`
                ).join('')}
            </optgroup>
        `;
    ...
    private updateDisplayValues(): void {
        ...
        (document.getElementById('maxForceSlider') as HTMLInputElement).value = (physics.maxForce * 100).toString();
        document.getElementById('maxForceValue')!.textContent = physics.maxForce.toFixed(1);
        
        (document.getElementById('maxSpeedSlider') as HTMLInputElement).value = (physics.maxSpeed * 100).toString();
        document.getElementById('maxSpeedValue')!.textContent = physics.maxSpeed.toFixed(1);
        
        (document.getElementById('frictionSlider') as HTMLInputElement).value = (physics.friction * 100).toString();
        document.getElementById('frictionValue')!.textContent = physics.friction.toFixed(2);
        
        (document.getElementById('minDistanceSlider') as HTMLInputElement).value = physics.minDistance.toString();
        document.getElementById('minDistanceValue')!.textContent = physics.minDistance.toString();
        
        (document.getElementById('maxDistanceSlider') as HTMLInputElement).value = physics.maxDistance.toString();
        document.getElementById('maxDistanceValue')!.textContent = physics.maxDistance.toString();
        
        (document.getElementById('trailLengthSlider') as HTMLInputElement).value = visual.trailLength.toString();
        document.getElementById('trailLengthValue')!.textContent = visual.trailLength.toString();
        
        (document.getElementById('particleSizeSlider') as HTMLInputElement).value = visual.particleSize.toString();
        document.getElementById('particleSizeValue')!.textContent = visual.particleSize.toString();
        
        (document.getElementById('glowIntensitySlider') as HTMLInputElement).value = (visual.glowIntensity * 100).toString();
    ...
    public updateStats(fps: number, particleCount: number, speciesCount: number): void {
