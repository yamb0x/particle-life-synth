...
export class TrailRenderer {
    ...
    public render(particles: Particle[], transform: Float32Array, glowIntensity: number): void {
        ...
        for (const particle of particles) {
            ...
            for (let i = 0; i < particle.trailX.length - 1; i++) {
                ...
                // First triangle
                vertices.push(
                    particle.trailX[i] + nx * width1,
                    particle.trailY[i] + ny * width1,
                    particle.trailX[i] - nx * width1,
                    particle.trailY[i] - ny * width1,
                    particle.trailX[i + 1] + nx * width2,
                    particle.trailY[i + 1] + ny * width2
                );
