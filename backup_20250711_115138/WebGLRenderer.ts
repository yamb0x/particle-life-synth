...
export class WebGLRenderer {
    ...
    // Particle rendering
    private particleVertexBuffer: WebGLBuffer;
    private particleColorBuffer: WebGLBuffer;
    private particleSizeBuffer: WebGLBuffer;
    private particleAlphaBuffer: WebGLBuffer;
    
    // Trail rendering
    private trailVertexBuffer: WebGLBuffer;
    private trailColorBuffer: WebGLBuffer;
    private trailAlphaBuffer: WebGLBuffer;
    
    // Uniforms
    private particleTransformUniform: WebGLUniformLocation;
    private particlePointSizeUniform: WebGLUniformLocation;
    private particleGlowIntensityUniform: WebGLUniformLocation;
    private trailTransformUniform: WebGLUniformLocation;
    ...
    private renderTrails(particles: Particle[], transform: Float32Array, glowIntensity: number): void {
        ...
        for (const particle of particles) {
            if (particle.trailX.length < 2) continue;
        ...
        if (trailVertices.length === 0) return;
    ...
    private renderParticles(particles: Particle[], transform: Float32Array, particleSize: number, glowIntensity: number): void {
