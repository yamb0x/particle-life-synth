export class ForceField {
    ...
    calculateForce(distance, species1, species2, isRunner = false) {
    ...
    interpolateForce(distance, params) {
    ...
    setForceField(species1, species2, params) {
        this.forceFields[species1][species2] = { ...params };
    }
    getForceField(species1, species2) {
