export class NonLinearForceField {
    ...
    createDefaultAdvancedField(species1, species2) {
    ...
    calculateAdvancedForce(distance, species1, species2, localDensity = 0, isRunner = false) {
    ...
    calculateZoneForce(distance, zone) {
        ...
        switch (forceType) {
            ...
            case 'sinusoidal':
                return forceParams.strength * Math.sin(normalizedDist * Math.PI * (forceParams.frequency || 1) + (forceParams.offset || 0));
            case 'step':
    ...
    getAdvancedField(species1, species2) {
        return this.advancedFields[species1][species2];
    }
    setAdvancedField(species1, species2, params) {
